...
grouped_df = df.groupby(['ML Pipeline Stage'])['Weighted Average'].mean().reset_index()
...
sorted_df.to_csv(r'D:\Me\concordia\Notes\SE4AI\project\Implementation\Implementation-Git\SOEN-691-Project\data\sorted_weighted_average_by_ML_Pipeline_Type2.csv', index=False)
